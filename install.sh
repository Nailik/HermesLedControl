...
echo "Debug 2 - crash is after here"
...
sudo -u "${USER}" bash <<EOF
    ...
    pip3 install --index-url=http://pypi.python.org/simple/ --trusted-host pypi.python.org -r requirements.txt --no-cache-dir
EOF
...
echo "Debug 3- crash is before here"
